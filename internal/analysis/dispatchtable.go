...
func ResolveDispatchTable(ctx *AnalysisContext) ([]ResolvedDispatchEntry, error) {
...
func resolveDispatchEntries(ctx *AnalysisContext, raw []cluster.DispatchTableEntry) []ResolvedDispatchEntry {
