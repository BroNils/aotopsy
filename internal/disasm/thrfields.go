...
var thrV217 = map[int]string{
	...
	// write_barrier_wrappers (19 entries: R0-R14, R19-R20, R23-R24)
	0x588: "wb_wrapper_R0",
	0x590: "wb_wrapper_R1",
	0x598: "wb_wrapper_R2",
	0x5a0: "wb_wrapper_R3",
...
var thrV3110 = map[int]string{
	...
	0xe8:  "late_init_error_nofpu_stub",
	0xf0:  "late_init_error_fpu_stub",
	0xf8:  "null_error_nofpu_stub",
	0x100: "null_error_fpu_stub",
	0x108: "null_arg_error_nofpu_stub",
	0x110: "null_arg_error_fpu_stub",
	0x118: "null_cast_error_nofpu_stub",
	0x120: "null_cast_error_fpu_stub",
	0x128: "range_error_nofpu_stub",
	0x130: "range_error_fpu_stub",
	0x138: "write_error_nofpu_stub",
	0x140: "write_error_fpu_stub",
	0x148: "field_access_error_nofpu_stub",
	0x150: "field_access_error_fpu_stub",
	0x158: "allocate_mint_fpu_stub",
	0x160: "allocate_mint_nofpu_stub",
	0x168: "async_exception_handler_stub",
	0x170: "resume_stub",
	0x178: "return_async_stub",
	0x180: "return_async_not_future_stub",
	...
	0x620: "suspend_state_init_async_ep",
	0x628: "suspend_state_await_ep",
	0x630: "suspend_state_await_type_check_ep",
	0x638: "suspend_state_return_async_ep",
	0x640: "suspend_state_return_async_not_future_ep",
	0x648: "suspend_state_init_async_star_ep",
	0x650: "suspend_state_yield_async_star_ep",
	0x658: "suspend_state_return_async_star_ep",
	0x660: "suspend_state_init_sync_star_ep",
	0x668: "suspend_state_suspend_sync_star_ep",
	0x670: "suspend_state_handle_exception_ep",
	// High offsets
	0x678: "isolate",
	0x680: "isolate_group",
...
var thrV3122 = map[int]string{
	...
	// Suspend state entry points
	0x628: "suspend_state_init_async_ep",
	0x630: "suspend_state_await_ep",
	0x638: "suspend_state_await_type_check_ep",
	0x640: "suspend_state_return_async_ep",
	0x648: "suspend_state_return_async_not_future_ep",
	0x650: "suspend_state_init_async_star_ep",
	0x658: "suspend_state_yield_async_star_ep",
	0x660: "suspend_state_return_async_star_ep",
	0x668: "suspend_state_init_sync_star_ep",
	0x670: "suspend_state_suspend_sync_star_ep",
	0x678: "suspend_state_handle_exception_ep",
	// High offsets
	0x680: "isolate",
	0x688: "isolate_group",
...
func mergeRuntimeEntries(m map[int]string, base int, names []string) {
	for i, name := range names {
		...
		if existing, exists := m[off]; exists {
			// C-2 fix: log if runtime entry name differs from existing static entry.
			if existing != name+"_ep" {
				fmt.Fprintf(os.Stderr, "warning: mergeRuntimeEntries: offset 0x%x has %q, skipping runtime entry %q\n", off, existing, name+"_ep")
			}
		} else {
			m[off] = name + "_ep"
		}
